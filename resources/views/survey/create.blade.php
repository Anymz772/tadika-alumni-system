        ...
        <div class="survey-container">
            ...
            <form method="POST" action="{{ route('survey.store') }}">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="current_workplace" class="form-label required">Current Workplace</label>
                            <input type="text" class="form-control"
                                id="current_workplace" name="current_workplace" value="{{ old('current_workplace') }}" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="job_position" class="form-label required">Job Position</label>
                            <input type="text" class="form-control"
                                id="job_position" name="job_position" value="{{ old('job_position') }}" required>
                        </div>
                    </div>
                </div>
