...
@section('title', 'Cipta Profil Saya')
@section('page-title', 'Cipta Profil')
@section('header-title', 'Cipta Profil Alumni Saya')
@section('header-subtitle', 'Isi maklumat peribadi dan profesional anda')
...
<div class="card shadow-sm">
    <div class="card-header bg-white">
        ...
        <h5 class="mb-0 text-primary">
            <i class="fas fa-user-edit me-2"></i>Cipta Profil
        </h5>
    </div>
    ...
    <form method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('alumni_state') is-invalid @enderror" 
                           id="alumni_state" name="alumni_state" value="{{ old('alumni_state', $alumni->alumni_state) }}" placeholder="cth. Selangor">
                    @error('alumni_state')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-footer bg-light d-flex justify-content-end gap-2 p-3">
            ...
            <button type="submit" class="btn btn-primary px-4">
                <i class="fas fa-save me-1"></i> Cipta Profil
            </button>
        </div>
    </form>
</div>
