                ...
                <form method="POST" action="{{ route('alumni.register') }}">
                    ...
                    <div class="form-section">
                        ...
                        <div class="alert alert-info">
                            <small><i class="fas fa-info-circle me-2"></i>Only basic information is required. Additional
                                details can be completed after registration via your profile page.</small>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        @if (isset($prefilledTadika))
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <i class="fas fa-magic me-2"></i> We've automatically filled in the details for
                                <strong>{{ $prefilledTadika->tadika_name }}</strong> based on your invitation link!
                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('tadika_name') is-invalid @enderror"
                                    ...
                                    placeholder="Search or enter tadika name">
                                @error('tadika_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-section">
                        <div class="alert alert-success">
                            ...
                            <strong>Quick Registration!</strong> Your account will be created immediately. You can log in
                            right after registration and complete additional information in your profile.
                        </div>

                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="terms" required>
                            <label class="form-check-label" for="terms">
                                I agree that the information provided is accurate and I consent to join the Tadika Alumni
                                Network.
                            </label>
                        </div>
