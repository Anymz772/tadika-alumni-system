...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4 p-3 bg-light border rounded">
                            <label class="form-label fw-bold">Alumni Registration Link</label>
                            <p class="small text-muted mb-2">Share this link with your alumni. It will pre-fill your Tadika
                                details on their registration page.</p>
                            <div class="input-group">
                                <input type="text" class="form-control"
                                    value="{{ route('alumni.register', ['ref' => $tadika->tadika_id]) }}" readonly
                                    id="alumniRegLink">

                                <button class="btn btn-outline-secondary" type="button" onclick="copyToClipboard()">Copy
                                    Link</button>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('tadika.profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="tadika_district"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="tadika_state"
                                        class="form-control @error('tadika_state') is-invalid @enderror" list="state-list"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="tadika_postcode"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="tadika_phone"
                                        class="form-control @error('tadika_phone') is-invalid @enderror"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="tadika_owner"
                                        class="form-control @error('tadika_owner') is-invalid @enderror"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="tadika_location"
                                        class="form-control @error('tadika_location') is-invalid @enderror"
                                        value="{{ old('tadika_location', $tadika->tadika_location ?? '') }}">
                                    @error('tadika_location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="tadika_logo"
                                    class="form-control @error('tadika_logo') is-invalid @enderror" accept="image/*">
                                @error('tadika_logo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
    ...
    <script>
        function copyToClipboard() {
            var copyText = document.getElementById("alumniRegLink");
            copyText.select();
